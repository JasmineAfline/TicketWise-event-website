...
class MpesaService {
  constructor() {
    ...
    this.consumerKey = process.env.MPESA_CONSUMER_KEY || "ppXJ2KPOzaRdfnxt7S4KhyQY7zUVBa4shN0NlQHiGBuVfHuK";
    this.consumerSecret = process.env.MPESA_CONSUMER_SECRET || "B4eiauNW29c6jALHJVSHDoSckOq4Ceabyr6vAU5ozXIdwcCSJZSfFtNRO6LSaHWa";
    ...
    this.callbackUrl = process.env.MPESA_CALLBACK_URL || "https://261a94ea0c6e.ngrok-free.app/api/bookings/mpesa/callback";
  }
